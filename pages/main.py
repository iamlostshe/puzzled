...
def edit_main_page(page: ft.Page) -> None:
    ...
    def is_rectangle_possible(n: int | str) -> bool:
    ...
    def check_form(e: ft.core.control_event.ControlEvent) -> None:
    ...
    def choice_of_tree_on_click(e: ft.core.control_event.ControlEvent) -> None:
...
def main_page(page: ft.Page) -> ft.SafeArea:
    ...
    plus_button = ft.FloatingActionButton(
        icon=ft.Icons.ADD,
        on_click=lambda e: main_page_on_click(e, page),
    )
